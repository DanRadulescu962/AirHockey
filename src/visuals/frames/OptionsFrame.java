...
public class OptionsFrame extends AbstractFrame {
	...
	public OptionsFrame(String name) {
		super(name);
		prepareButtons();
		frameLabel = new JLabel(SingletonResources.getInstance().getOpFrame());
	...
	public OptionsFrame(String name, AbstractFrame previousFrame){
		this(name);
